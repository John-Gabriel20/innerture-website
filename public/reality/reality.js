...
document.addEventListener("DOMContentLoaded", () => {
        ...
        engineNav.addEventListener('click', (e) => { 
            ...
            if (engineModal) {
                ...
                if (content && typeof anime !== 'undefined') {
                    anime({ targets: content, scale: [0.8, 1], translateY: [20, 0], opacity: [0, 1], duration: 600, easing: 'easeOutElastic(1, .6)' });
                }
            }
        });
    }
    ...
    async function triggerAnalysis() {
        ...
        if (!text) {
            if (typeof anime !== 'undefined') anime({ targets: inputField, translateX: [0, -10, 10, -10, 10, 0], duration: 400 });
            return;
        }
