...
function renderFeed(path) {
  ...
  data.reviews.forEach((r, i) => {
    ...
    // Add inside tip outside the card if it exists
    if (r.insideTip) {
...
/* ══════════════════════════════════════════════
   RENDER ANALYTICS
   Table columns: Role | Hiring Level | Workplace | Days Off / Style | Salary / yr
══════════════════════════════════════════════ */
...
window.changePath = (newPath) => {
  ...
  if (!data) { console.error(`Path "${newPath}" not found in careerData.`); return; }
