document.addEventListener("DOMContentLoaded", () => {
    ...
    const jobData = {
        ...
        graphic_des: {
            accent:     "#ffa502",
            accentDim:  "rgba(255,165,2,0.10)",
            accentGlow: "rgba(255,165,2,0.25)",
            title: "Visual Brief",
        ...
        ux_ui: {
            accent:     "#1abc9c",
            accentDim:  "rgba(26,188,156,0.10)",
            accentGlow: "rgba(26,188,156,0.25)",
        ...
        data_sci: {
            accent:     "#3498db",
            accentDim:  "rgba(52,152,219,0.10)",
            accentGlow: "rgba(52,152,219,0.25)",
        ...
        video_ed: {
            accent:     "#9b59b6",
            accentDim:  "rgba(155,89,182,0.10)",
        ...
        creative_prod: {
            accent:     "#e67e22",
            accentDim:  "rgba(230,126,34,0.10)",
            accentGlow: "rgba(230,126,34,0.25)",
        ...
        photog_video: {
            accent:     "#ff00ea",
            accentDim:  "rgba(255,0,234,0.10)",
            accentGlow: "rgba(255,0,234,0.25)",
            title: "Visual Brief",
        ...
        content_cre: {
            accent:     "#f1c40f",
            accentDim:  "rgba(241,196,15,0.10)",
            accentGlow: "rgba(241,196,15,0.25)",
            title: "Viral Brief",
    ...
    window.switchTab = (e, tabId) => {
        ...
        const progressMap = { 'overview': 33, 'task': 66, 'workspace': 100 };
        if (progressBar) progressBar.style.width = progressMap[tabId] + '%';
    };
